class Enquiry < ActiveRecord::Base
  ...
  scope :need_feedback, lambda { where("owner_accepted IS NOT FALSE AND (date < ? AND (duration = 'morning' OR duration = 'afternoon' OR duration = 'evening' OR duration = 'overnight')) OR \
