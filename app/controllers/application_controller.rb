class ApplicationController < ActionController::Base
  ...
  def get_useable_name_of_action(action)
    ...
    when "homestays"
      ...
      when "favourite"
        return "Clicked on Favourite for Homestay id: #{params[:id]}"
      when "non_favourite"
        return "Un-favourited homestay id: #{params[:id]}"
      when "new"
        return "Creating new homestay"
      when "edit"
        return "Changed homestay id: #{params[:id]}"
      when "activate"
    ...
    when "guest/pets"
      ...
      when "edit"
        return "Editing a pet #{params[:id]}"
      when "destroy"
        return "Deleting a pet #{params[:id]}"
      when "create"
        return "Finished creating a new pet"
      when "update"
        return "Finished editing pet #{params[:id]}"
      when "index"
    ...
    when "bookings"
      ...
      when "host_receipt"
        return "Host viewing receipt for booking #{params[:booking_id]}"
      when "host_confirm"
